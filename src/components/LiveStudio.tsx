      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            <div className="bg-white/5 border border-white/10 rounded-lg overflow-hidden aspect-video relative">
              {isLive ? (
                ...
                <div className="w-full h-full bg-gradient-to-br from-gray-900/20 to-black flex items-center justify-center relative">
                  <img
                  ...
                  <div className="relative text-center z-10">
                    ...
                    <p className="text-2xl font-bold text-gray-300 mb-2">Currently Offline</p>
            ...
            <div className="mt-6 bg-white/5 border border-white/10 rounded-lg p-6">
              <h3 className="text-2xl font-bold mb-4 text-white">About Live Sessions</h3>
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-6">
              ...
              <div className="space-y-4">
                <div className="border-l-2 border-white/20 pl-4">
                  ...
                  <p className="font-semibold text-white">Beat Making Session</p>
                ...
                <div className="border-l-2 border-white/20 pl-4">
                  ...
                  <p className="font-semibold text-white">Q&A + Production Tips</p>
                  <p className="text-sm text-gray-400">Ask me anything</p>
                </div>
              </div>
            </div>

            <button className="w-full py-4 bg-red-600 hover:bg-red-700 rounded-lg font-bold transition-all hover:scale-105">
              Set Reminder
            </button>

            <div className="bg-white/5 border border-white/10 rounded-lg p-6">
              <h3 className="text-lg font-bold mb-3 text-white">Follow on Socials</h3>
              ...
              <div className="space-y-2">
                <a
                  ...
                  className="block w-full py-2 bg-white/5 hover:bg-white/10 border border-white/10 rounded-lg text-center font-medium transition-all"
                >
                  YouTube
                </a>
                <a
