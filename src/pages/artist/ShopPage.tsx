    ...
    <ArtistLayout>
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-400 mt-2">Browse and license high-quality beats by Jonna Rincon</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {beats.map((beat) => (
              <div
                key={beat.id}
                className="bg-gray-800 border border-gray-700 rounded-xl overflow-hidden hover:border-orange-500/50 transition-all hover:transform hover:scale-105"
              >
                {/* Beat Artwork */}
